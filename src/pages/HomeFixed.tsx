...
export default function HomeFixed({ onNavigate }: HomeProps) {
  ...
  const stats = [
    { value: '20+', label: 'Countries Reached', icon: '🌍' },
      ...
      <section className="relative h-[600px] md:h-[700px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-4xl mx-auto text-center text-white z-10 pb-32 md:pb-40 drop-shadow-2xl">
            ...
            <p className="text-xl md:text-3xl mb-8 text-amber-300 font-semibold animate-slide-up animation-delay-200 text-shadow-lg">
              Driving Opportunities Beyond Borders
            </p>
            <p className="text-base md:text-lg mb-10 text-gray-100 max-w-3xl mx-auto animate-slide-up animation-delay-400 text-shadow-md">
