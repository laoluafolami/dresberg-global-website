          ...
          <div className="space-y-16">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-white dark:bg-slate-900 rounded-2xl shadow-lg overflow-hidden transition-colors ${
                    !isActive ? 'opacity-90' : ''
                  }`}
                >
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8 lg:p-12">
                    <div className="lg:col-span-1">
                      ...
                      <h2 className="text-3xl font-bold text-blue-900 dark:text-white mb-4">{service.title}</h2>
                    ...
                    <div className="lg:col-span-2">
                      <h3 className="text-xl font-bold text-blue-900 dark:text-white mb-4">Key Features & Services</h3>
                      ...
                      {service.caseStudy && (
                        <div className="bg-gradient-to-br from-blue-50 to-white dark:from-slate-800 dark:to-slate-700 p-6 rounded-lg border border-blue-100 dark:border-slate-600">
                          <h4 className="font-bold text-blue-900 dark:text-white mb-2">Success Story</h4>
                          <p className="text-gray-700 dark:text-gray-300 italic">{service.caseStudy}</p>
                        </div>
                      )}
                    </div>
                  </div>
